    ...
    value: function () {
      function render() {
        ...
        return React.createElement(
          'div',
          css(styles.DateInput, withCaret && styles.DateInput__withCaret, disabled && styles.DateInput__disabled, withCaret && openDirection === OPEN_DOWN && styles.DateInput__openDown, withCaret && openDirection === OPEN_UP && styles.DateInput__openUp),
          React.createElement('input', _extends({}, css(styles.DateInput_input, readOnly && styles.DateInput_input__readOnly, focused && styles.DateInput_input__focused, disabled && styles.DateInput_input__disabled), {
