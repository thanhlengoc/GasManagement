...
function SingleDatePickerInput(_ref) {
  ...
  var closeIcon = customCloseIcon || React.createElement(CloseButton, css(styles.SingleDatePickerInput_clearDate_svg));
  ...
  return React.createElement(
    ...
    showClearDate && React.createElement(
      'button',
      _extends({}, css(styles.SingleDatePickerInput_clearDate, !customCloseIcon && styles.SingleDatePickerInput_clearDate__default, !displayValue && styles.SingleDatePickerInput_clearDate__hide), {
        type: 'button',
