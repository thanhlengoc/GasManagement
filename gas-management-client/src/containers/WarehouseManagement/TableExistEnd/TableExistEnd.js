    ...
    return (
        <BootstrapTable
          ...
          <TableHeaderColumn row='1' colSpan='3' csvHeader='Elf Gas'
            ...
            <TableHeaderColumn row='2' dataField='elf6kg' width='120' dataAlign='center'>Elf 6kg</TableHeaderColumn>
            <TableHeaderColumn row='2' dataField='elf12kg' width='120' dataSort>Elf 12kg</TableHeaderColumn>
            <TableHeaderColumn row='2' dataField='elf39kg' width='120'>Elf 39kg</TableHeaderColumn>

          <TableHeaderColumn row='1' colSpan='2' csvHeader='PM'
                             headerAlign='center'>PM</TableHeaderColumn>
          <TableHeaderColumn row='2' dataField='b12' width='120'>B12</TableHeaderColumn>
          <TableHeaderColumn row='2' dataField='b45' width='120'>B45</TableHeaderColumn>
          ...
          <TableHeaderColumn row='2' dataField='shellElf6kg' width='120'>Elf 6kg</TableHeaderColumn>
          <TableHeaderColumn row='2' dataField='shellElf12kg' width='120'>Elf 12kg</TableHeaderColumn>
          <TableHeaderColumn row='2' dataField='shellElf39kg' width='120'>Elf 39kg</TableHeaderColumn>
          <TableHeaderColumn row='2' dataField='shellB12' width='120'>B12</TableHeaderColumn>
          <TableHeaderColumn row='2' dataField='shellB45' width='120'>B45</TableHeaderColumn>

          <TableHeaderColumn row='0' colSpan='3' csvHeader='Khuyến mãi'
                             headerAlign='center'>Khuyến mãi</TableHeaderColumn>
          <TableHeaderColumn row='1' rowSpan='2' dataField='oil' width='100'>Dầu</TableHeaderColumn>
          <TableHeaderColumn row='1' rowSpan='2' dataField='sugar' width='120'>Đường</TableHeaderColumn>
          <TableHeaderColumn row='1' rowSpan='2' dataField='glass' width='100'>Ly</TableHeaderColumn>
        </BootstrapTable>
    );
  }
}
