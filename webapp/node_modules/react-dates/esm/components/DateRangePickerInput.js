...
function DateRangePickerInput(_ref) {
  ...
  var arrowIcon = customArrowIcon || (isRTL ? React.createElement(LeftArrow, css(styles.DateRangePickerInput_arrow_svg)) : React.createElement(RightArrow, css(styles.DateRangePickerInput_arrow_svg)));
  var closeIcon = customCloseIcon || React.createElement(CloseButton, css(styles.DateRangePickerInput_clearDates_svg));
  ...
  return React.createElement(
    ...
    showClearDates && React.createElement(
      ...
      }, css(styles.DateRangePickerInput_clearDates, !customCloseIcon && styles.DateRangePickerInput_clearDates_default, !(startDate || endDate) && styles.DateRangePickerInput_clearDates__hide), {
